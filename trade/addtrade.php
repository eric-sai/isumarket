    ...
    <html lang="en">
		...
		<body>
       		<form action="../trade/addtradeToDB.php" method="post" id="trade-form" novalidate="novalidate" enctype="multipart/form-data">
  
   				<label>Product name</label>
				<input type="text" value="" name="pname" id="pname" ng-pattern="/^[a-zA-Z0-9]{4,10}$/"  required>	
				<label>category</label>
				<input type="text" value="" name="category" id="category" required>
				<label>price</label>
				<input type="text" value="" name="price" id="price" ng-pattern="/^[0-9]/" required>
                <label>quantity</label>
				<input type="text" name="quantity" id="quantity" ng-pattern="/^[0-9]/" required>
                <label>image</label>
				<div id="preview">
