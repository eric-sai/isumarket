...
//get today time and then output pid and then get result;
if(isset($_GET["page"])){
	$page=$_GET["page"];
}
else{
...
$today = getdate();
$time=$today['year']."-".$today['mon']."-".$today['mday']." "."00:00:00";
$result=getPostTime($time,($page-1)*8,8);
//echo $re['trade_ID'];
?>
<html>
<body>
	...
	<?php
          	...
          	echo '<a href="?page=1"> 1 </a><a href="?page='.($page+1).'"> next</a>';
		  ?>
	</div>	
	</div>	
