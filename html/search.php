...
$formname="trade";
$selectlist=array("p_name","description","category");
$keywordlist=array($_GET['search'],$_GET['search'],$_GET['search']);
$orderAttribute="post_time DESC";
$relation=array("|","|");
$result= matchingLimit($selectlist,$keywordlist,$relation, $orderAttribute,($page-1)*8,8);
...
<body>
    <div class="container">
		...
		<br clear="all" />
          	...
          	echo '<a href="?page=1&search='.$_GET['search'].'"> 1 </a><a href="?page='.($page+1).'&search='.$_GET['search'].'"> next</a>';
		  ?>
